...
class TaskResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            /**
             * @var integer Görevdeki toplam soru sayısı
             * @example 1
             */
            'questions_count' => $this->questions_count,

            /**
             * @var integer Görevdeki cevaplanan toplam soru sayısı
             * @example 1
             */
            'answered_questions_count' => $this->answered_questions_count,

            /**
             * @var QuestionListResource[] Görevin içindeki soruları verir.
             */
