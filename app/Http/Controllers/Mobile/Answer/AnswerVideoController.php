...
use App\Http\Requests\Mobile\Answer\AnswerVideoRequest;
 ...
 */
class AnswerVideoController extends Controller
{
     ...
     * Create Video Answer
     *
     * Bu servis soru tipi video ise kullanılması gereken servistir.
     *
     * @requestMediaType multipart/form-data
     *
     */
    public function create(AnswerVideoRequest $request)
    {
     ...
     *
     */
    public function update(AnswerVideoRequest $request)
    {
        $userId = null;
        $questionId = $request->id;
        if (!$userId = @(Auth::guard('user-api')->user())->id) {
