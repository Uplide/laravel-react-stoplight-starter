...
function RouteSearcher() {
    ...
    return (
        <React.Fragment>
            <Button
                onClick={onOpen}
                className="flex w-full justify-between p-3 text-xs leading-4 whitespace-nowrap rounded-xl border border-solid bg-zinc-800 border-zinc-600 font-[450] text-zinc-400"
                startContent={
                ...
                endContent={
                    <Kbd className="bg-[#404040] text-[#b5b5b5]">
