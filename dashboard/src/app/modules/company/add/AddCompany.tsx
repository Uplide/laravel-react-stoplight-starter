...
import { ICompanyCreateRequest } from "../core/models/company.interface";
import * as Yup from "yup";
import { addCompany } from "../core/api/company.request";
...
// import ImagePicker from "@app/modules/file-manager/components/ImagePicker";
  ...
  return (
    <>
      <div className="flex gap-1 items-center mb-8">
        ...
        <h2 className="text-[1.25rem] font-bold">Yeni şirket</h2>
      </div>{" "}
