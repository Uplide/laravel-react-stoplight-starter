...
const TaskForm: React.FC = () => {
  ...
  const addQuestion = (taskIndex: number) => {
    formik.setFieldValue(`tasks.${taskIndex}.questions`, [
      ...
      { title: "", type: "", options: [{ value: "" }], isCollapsed: false },
    ]);
  };
    ...
    <FormikProvider value={formik}>
      <form onSubmit={formik.handleSubmit}>
        <Card className="w-full" shadow="none">
          <CardBody className="px-0 pb-0 mb-3">
                                      ...
                                      >
                                        {!task.isCollapsed ? (
                                          <>
                                            ...
                                            {formik.touched.tasks?.[taskIndex]
                                              ?.title &&
                                            (formik.errors.tasks?.[
                                              taskIndex
                                            ] as any)?.title?.length ? (
                                                                          ...
                                                                          {!question.isCollapsed ? (
                                                                            <>
                                                                              ...
                                                                              <div className="mt-2">
                                                                                ...
                                                                                <Select
                                                                                  id={`tasks.${taskIndex}.questions.${questionIndex}.type`}
                                                                                  name={`tasks.${taskIndex}.questions.${questionIndex}.type`}
                                                                                  value={
                                                                                    question.type
                                                                                  }
                                                                                  selectedKeys={[
                                                                                  ...
                                                                                  variant="bordered"
                                                                                  size="sm"
                                                                                  aria-labelledby={`tasks.${taskIndex}.questions.${questionIndex}.type-label`}
                                                                                >
                                                                                  <SelectItem
                                                                                    key={
                                                                                      "radio"
                                                                                                    ...
                                                                                                    >
                                                                                                      {(
                                                                                                        ...
                                                                                                        >
                                                                                                          ...
                                                                                                          <Input
                                                                                                            type="text"
                                                                                                            id={`tasks.${taskIndex}.questions.${questionIndex}.options.${optIndex}.value`}
                                                                                                            name={`tasks.${taskIndex}.questions.${questionIndex}.options.${optIndex}.value`}
                                                                                                            variant="bordered"
                                                                                                            className="w-full"
                                                                                                            size="sm"
                                                                                                            placeholder={
